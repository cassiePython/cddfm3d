...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--learning_rate', type=float, default=0.001, help='initial learning rate')
        ...
        self._parser.add_argument('--weight_wpdc', type=float, default=0.1, help='WPDC training weight')
