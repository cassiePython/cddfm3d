...
from finetunemodel import Generator, Discriminator
...
def train(args, loader, generator, discriminator, g_optim, d_optim, g_ema, device):
    ...
    for idx in pbar:
        ...
        # directly freeze the generator: similar results to fixing only affine layers   
        ...
        if get_rank() == 0:
            ...
            if i % 1000 == 0:
                torch.save(
                    {
                        "g": g_module.module.state_dict(), # add module for multi-gpu
                        "d": d_module.module.state_dict(),
